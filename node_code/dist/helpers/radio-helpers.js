...
(function (factory) {
    ...
    function filterOutputFrequencies(...bands) {
        return (filter) => (bands.includes(FrequencyBand.$160_m) && ((filter.Frequency.Output >= 1.8 && filter.Frequency.Output <= 2.0) || (filter.Frequency.Input >= 1.8 && filter.Frequency.Input <= 2.0))) ||
