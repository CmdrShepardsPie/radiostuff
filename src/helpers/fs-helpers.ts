...
export async function writeToJsonAndCsv(filename: string, jsonData: any, csvData: any = jsonData, header = true) {
  ...
  const csvString = await stringifyAsync(csvPrep, {header});
